...
const SingleView = () => {
  ...
  const pathExample = [
   ...
   /*
  const audioEx = [{coord: {lat: -27.360349, lng: 152.963009}, file: "./test.mp3"}, 
                    {coord: {lat: -27.346084, lng: 152.975356}, file: "./test2.mp3"}];
   */

  const audioEx = [{lat: -27.360349, lng: 152.963009}, 
                    {lat: -27.346084, lng: 152.975356}];                  
